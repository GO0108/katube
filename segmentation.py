...
def segment_audio(audio_path, output_dir, model_vad,vad_iterator, min_duration_sec=4, max_duration_sec=15, tgt_sampling_rate=24000):
...
def main():
    ...
    parser.add_argument('--audio_file', default='/app/output/channel/UCib793mnUOhWymCh2VJKplQ/iAA8NrfQtHo/iAA8NrfQtHo.wav', help='Filename to input audio file')
    ...
    (get_speech_timestamps, save_audio, read_audio, VADIterator, collect_chunks) = utils
    vad_iterator = VADIterator(model_vad)
    segment_audio(audio_path, output_dir, model_vad, vad_iterator)
